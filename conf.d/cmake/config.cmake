...
# ----------------------------------------------------
set(CLOSING_MESSAGE "Typical binding launch: afb-binder --name afbd-redis-tsdb-binding --port=${AFB_REMPORT} --workdir=${CMAKE_BINARY_DIR} --ldpath=/dev/null --binding=package/lib/redis-binding.so --roothttp=package/htdocs --tracereq=common --verbose")
